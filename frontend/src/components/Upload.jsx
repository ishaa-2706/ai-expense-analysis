...
export default function Upload() {
  ...
  const getFileInfo = () => {
    ...
    if (ext === "pdf")  return { icon: "📄", label: "PDF",   color: "#EF4444", bg: "#FEE2E2" };
    if (ext === "csv")  return { icon: "📊", label: "CSV",   color: "#10B981", bg: "#D1FAE5" };
    return               { icon: "📗", label: "Excel", color: "#3B82F6", bg: "#DBEAFE" };
  };
  ...
  const handleUpload = async () => {
    ...
    // PDF uses /upload-pdf (existing backend route); CSV/Excel use /api/analyze
    ...
    try {
      ...
      // For large PDFs, simulate progress ticks so UI doesn't feel frozen
      let tick = 30;
      ...
      // /upload-pdf may return { analysisData: {...} } or flat shape — handle both
      ...
      <div style={pg.main}>
        ...
        <div style={pg.center}>
          <div className="sw-card fade-in" style={{ maxWidth: 560, width: "100%", padding: 36 }}>
            ...
            >
              ...
              {file ? (
                <div style={{ display: "flex", alignItems: "center", gap: 14, textAlign: "left" }}>
                  <div style={{ width: 52, height: 52, borderRadius: 13, background: fi.bg, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26, flexShrink: 0 }}>
                    {fi.icon}
                  </div>
                  ...
                  <button
                    ...
                    style={{ background: "#FEE2E2", border: "none", color: "#EF4444", width: 30, height: 30, borderRadius: "50%", cursor: "pointer", fontSize: 13, fontWeight: 700, flexShrink: 0 }}
                  >
                    ✕
                  </button>
                </div>
              ...
              <div style={{ background: "#F8FAFC", border: "1.5px solid #E5E7EB", borderRadius: 14, padding: "16px 18px", marginBottom: 4, marginTop: -8 }}>
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <button
                    ...
                    style={{ background: "#EDE9FE", border: "none", borderRadius: 10, width: 42, height: 42, cursor: "pointer", fontSize: 16, display: "flex", alignItems: "center", justifyContent: "center" }}
                  >
                    {showPassword ? "🙈" : "👁️"}
                  </button>
                </div>
              ...
              <div style={{ marginTop: 20 }}>
                ...
                {isPdf && progress < 90 && (
                  <div style={{ fontSize: 11, color: "#9CA3AF", marginTop: 6, textAlign: "center" }}>
                    Large PDFs may take a moment — hang tight ☕
                  </div>
                )}
              </div>
            )}
            ...
            >
              {loading
                ? <><span style={pg.spinner} /> Processing…</>
...
const pg = {
  ...
  title:   { fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 22, fontWeight: 700, color: "#0F172A" },
